...
> [!Warning] Status
> Bonfire Social 1.0 is ready! Other flavours of Bonfire are currently at alpha or beta stages and may not be ready to use. 


> [!important]
> These instructions are for setting up Bonfire in production. If you want to run the backend in development, please refer to our [Installation guide](./HACKING.md) instead.
